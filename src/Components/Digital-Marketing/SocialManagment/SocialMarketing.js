    ...
    return (
        ...
        <h2 className='text-start'>Category</h2> <br /> 
            <div className='mega-box'>
                 <p className='text-start bg-color rounded-pill px-1'> Social Media Management</p>
                <p className='text-start bg-color rounded-pill px-1'>Social Media Advertising</p>
...
<br /> 
  ...
  <option selected>Social Media Management</option>
